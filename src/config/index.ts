...
export const envConfigs: ConfigMap = {
  ...
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'YouTube Automation AI',
  app_description:
    process.env.NEXT_PUBLIC_APP_DESCRIPTION ??
    'Turn long videos into viral-ready shorts with AI clipping, hook optimization, and trend-driven remix workflows.',
  app_logo: process.env.NEXT_PUBLIC_APP_LOGO ?? '/logo-mark.svg',
