...
const models: ToolModelDefinition[] = [
  ...
  },
  {
    ...
    ui: {
      family: {
        key: 'sora',
        label: 'Sora',
        description: 'Narrative motion with style presets and thumbnails',
        badge: 'Audio',
      },
      mark: 'S',
      outputLabel: '10-15s',
  ...
  },
  {
    ...
    endpointFamily: 'video',
    description:
      'Sora 2 tier with broader queue priority and the same styled output controls',
    modeSupport: ['text-to-video', 'image-to-video'],
    supportedOptions: [
      'duration',
      'aspect_ratio',
  ...
  },
  {
    ...
    endpointFamily: 'video',
    description:
      'Highest Sora tier with longer clips and the same style, watermark, and thumbnail controls',
    modeSupport: ['text-to-video', 'image-to-video'],
    supportedOptions: [
      'duration',
      'aspect_ratio',
