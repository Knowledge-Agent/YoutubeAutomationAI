...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: t('groups.storage_default'),
      description: 'choose the default storage provider to use',
      tab: 'storage',
    },
    {
      name: 's3',
      title: t('groups.s3'),
      description: 'custom your aws s3 settings',
      tab: 'storage',
    },
    {
      name: 'apimart',
...
export async function getSettings() {
  const settings: Setting[] = [
    {
      name: 'app_name',
      title: 'App Name',
      placeholder: 'YouTube Automation AI',
      type: 'text',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'youtubeautomationai.com',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'YouTube Automation AI <no-reply@youtubeautomationai.com>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      tip: 'Choose which configured storage provider should be used by default',
      group: 'storage_default',
      tab: 'storage',
    },
    {
      name: 's3_access_key',
    ...
    },
    {
      ...
      tip: 'AWS S3 region. Example: us-east-1, ap-southeast-1',
      group: 's3',
      tab: 'storage',
    },
    {
    ...
    },
    {
      ...
      tip: 'Leave empty to use the default AWS S3 endpoint for the selected region',
      group: 's3',
      tab: 'storage',
    },
    {
      ...
      tip: 'Optional CDN or public domain for uploaded files',
      group: 's3',
      tab: 'storage',
    },
    {
