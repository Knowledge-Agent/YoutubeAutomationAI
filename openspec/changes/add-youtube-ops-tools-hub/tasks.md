...
- [x] 1.1 Add a shared AI tools catalog with stable categories and tool
      route metadata
...
## 3. AI Video Generator Separation

- [x] 3.1 Restore `/ai-video-generator` to a generator-first surface
- [x] 3.2 Remove default business-tool cards from the AI video
      generator page
